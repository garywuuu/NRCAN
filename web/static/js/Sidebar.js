...
Sidebar.prototype.init = function()
{
	...
	this.setCurrentSearchEntryLibrary('GR4ML');
	this.addImagePalette('GR4ML', mxResources.get('GR4ML'), dir + '/GR4ML/', '.svg',
	['actor', 'algorithm', 'all-indicator', 'analytics-goal', 'and', 'answers', 'arrow', 'association',
	'business-goal', 'decision-goal', 'decomposition', 'denied', 'desires', 'entity', 'evaluates', 'green-indicator', 
	'influence--', 'influence-', 'influence-q', 'influence', 'influence+', 'influence++', 'inputs-output', 
	'insight', 'no-indicator', 'note', 'operator', 'or', 'performs', 'question-goal', 'red-indicator', 
   'relationship', 'satisfied', 'softgoal', 'yellow-indicator']);
